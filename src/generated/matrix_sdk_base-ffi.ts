...
interface NativeModuleInterface {
  ...
  ffi_matrix_sdk_base_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeMatrixSdkBase`
// if it was added via JSI.
//
// The empty object is there for testing purposes only, and may be removed.
export default ((globalThis as any).NativeMatrixSdkBase ??
